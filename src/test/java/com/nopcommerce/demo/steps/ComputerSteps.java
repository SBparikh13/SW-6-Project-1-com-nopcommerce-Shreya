...
public class ComputerSteps {
    ...
    public void iFillTheAllMandatoryField() {
        new BillingPage().enterFirstname("Kiara");
        new BillingPage().enterLastname("Parikh");
        new BillingPage().enterEmail("kp1309@gmail.com");
        new BillingPage().selectCountry("United Kingdom");
        new BillingPage().enterCity("London");
        new BillingPage().enterAddress("61, Maven road");
        new BillingPage().enterPostcode("T123NG");
        new BillingPage().enterPhoneNumber("079124841492");
    }
